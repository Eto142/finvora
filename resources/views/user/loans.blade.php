...
@include('user.header')
 ...
 Support-->
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="https://account.finvoradigital.com/dashboard/my-loans" class="px-4 py-2 rounded-lg bg-surface-overlay border border-surface-border text-content-secondary hover:text-content-primary text-sm font-medium transition-colors">
            My Loans
        </a>
    </div>
        ...
        <div class="lg:col-span-2 space-y-4">
            ...
            <div x-show="selectedPlan" x-cloak class="rounded-xl bg-surface-raised border border-surface-border p-6">
                ...
                <form action="https://account.finvoradigital.com/dashboard/loans/store" method="POST" class="space-y-4">
    ...
    function loanCalculator() {
        return {
            ...
            async fetchPreview() {
                ...
                this.loading = true;
                try {
                    const resp = await fetch('https://account.finvoradigital.com/dashboard/loans/calculate-preview', {
                        method: 'POST',
                        headers: {
