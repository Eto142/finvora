...
>
 ...
 Dashboard
            ...
            <!--<a href="{{route('user.dashboard')}}/portfolio" class="nav-link-item ">-->
            <!--    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Investment Plans
                                    ...
                                    <a href="{{route('user.dashboard')}}/pre-ipo" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
</svg>
 Pre-IPO
            </a>
                                    <a href="{{route('user.dashboard')}}/stocks" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Trading Signals</span>
                ...
                <div x-show="open" x-transition x-cloak class="ml-8 space-y-0.5 mt-0.5">
                    <a href="{{route('user.dashboard')}}/singalssubscriptions" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">Signals</a>
                    <a href="{{route('user.dashboard')}}/subscribe-signals" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">Signal Plans</a>
                    <a href="{{route('user.dashboard')}}/my-subscriptions" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">My Subscriptions</a>
                </div>
            </div>
                                    <div x-data="{ open: false }">
                <button @click="open = !open" class="w-full nav-link-item flex items-center justify-between ">
 ...
 NFT Market</span>
                ...
                <div x-show="open" x-transition x-cloak class="ml-8 space-y-0.5 mt-0.5">
                    <a href="{{route('user.dashboard')}}/nft-gallery" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">Gallery</a>
                    <a href="{{route('user.dashboard')}}/my-nfts" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">My Collection</a>
                    <a href="{{route('user.dashboard')}}/nfts/create" class="block py-1.5 px-3 text-sm rounded-lg text-content-tertiary hover:text-content-primary transition-colors">Mint NFT</a>
                </div>
            </div>
            
            
            <p class="nav-group-label">Trading</p>
                        <a href="{{route('user.dashboard')}}/trade" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
</svg>
 Open Trade
            </a>
            <a href="{{route('user.dashboard')}}/markets" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3m0 0a8.997 8.997 0 0 1 7.843 4.582M12 3a8.997 8.997 0 0 0-7.843 4.582m15.686 0A11.953 11.953 0 0 1 12 10.5c-2.998 0-5.74-1.1-7.843-2.918m15.686 0A8.959 8.959 0 0 1 21 12c0 .778-.099 1.533-.284 2.253m0 0A17.919 17.919 0 0 1 12 16.5a17.92 17.92 0 0 1-8.716-2.247m0 0A9.015 9.015 0 0 1 3 12c0-1.605.42-3.113 1.157-4.418" />
</svg>
 Markets
            </a>
                                    <a href="{{route('user.dashboard')}}/copy-trading" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Copy Trading
                        ...
                        <a href="{{route('user.dashboard')}}/tradinghistory" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Trade History
            ...
            <a href="{{route('user.dashboard')}}/courses" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
  <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.438 60.438 0 0 0-.491 6.347A48.62 48.62 0 0 1 12 20.904a48.62 48.62 0 0 1 8.232-4.41 60.46 60.46 0 0 0-.491-6.347m-15.482 0a50.636 50.636 0 0 0-2.658-.813A59.906 59.906 0 0 1 12 3.493a59.903 59.903 0 0 1 10.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0 1 12 13.489a50.702 50.702 0 0 1 7.74-3.342M6.75 15a.75.75 0 1 0 0-1.5.75.75 0 0 0 0 1.5Zm0 0v-3.675A55.378 55.378 0 0 1 12 8.443m-7.007 11.55A5.981 5.981 0 0 0 6.75 15.75v-1.5"/>
</svg>
 Courses
            </a>
            <a href="{{route('user.dashboard')}}/my-courses" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
 ...
 My Courses
            ...
            <a href="{{route('user.dashboard')}}/account-settings" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
 ...
 Profile & Settings
                        ...
                        <a href="{{route('user.dashboard')}}/verify-account" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" />
</svg>
 Verification
            </a>
                        <a href="{{route('user.dashboard')}}/referuser" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
</svg>
 Referral Program
            </a>
            <a href="{{route('user.dashboard')}}/news" class="nav-link-item ">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" />
</svg>
 Market News
            </a>
            <!--<a href="{{route('user.dashboard')}}/support" class="nav-link-item ">-->
            <!--    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5" aria-hidden="true">
...
-->
 ...
 Logout
                ...
                <div class="relative"
                     x-data="{
                         ...
                         loadNotifs() {
                             ...
                             fetch('{{route('user.dashboard')}}/notifications/unread', { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                                 .then(r => r.json())
                                 .then(d => { this.notifs = d.notifications; this.count = d.count; this.loaded = true; });
                         },
                         markAllRead() {
                             fetch('{{route('user.dashboard')}}/notifications/read-all', { method: 'POST', headers: { 'X-CSRF-TOKEN': '4H60DyDUvWAS66zocDJnVrbaeRcvMv4w7PZgSi5d', 'X-Requested-With': 'XMLHttpRequest' } })
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                        ...
                        <a href="{{route('user.dashboard')}}/notification" class="block text-center text-xs text-primary hover:text-primary-light py-3 border-t border-surface-border transition-colors">View all notifications</a>
                    </div>
                </div>

                
                                                            <a href="{{route('user.dashboard')}}/verify-account" class="hidden sm:inline-flex items-center gap-1 text-xs font-medium text-warning bg-warning/10 px-2.5 py-1 rounded-full hover:bg-warning/20 transition-colors">
 ...
 Verify KYC
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                    ...
                    <div x-show="userDropdown" x-cloak x-transition
                        ...
                        <a href="{{route('user.dashboard')}}/account-settings" class="flex items-center gap-2 px-4 py-2.5 text-sm text-content-secondary hover:bg-surface-overlay hover:text-content-primary transition-colors">
