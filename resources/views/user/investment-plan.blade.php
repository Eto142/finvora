@include('user.header')
 ...
 Support-->
    ...
    <div class="flex items-center justify-end gap-3 mb-6">
        <a href="https://account.finvoradigital.com/dashboard/myplans/All" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-surface-overlay border border-surface-border text-content-secondary hover:text-content-primary text-sm font-medium transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4" aria-hidden="true">
